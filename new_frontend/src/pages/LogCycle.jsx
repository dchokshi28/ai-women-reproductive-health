    ...
    <div className="max-w-2xl mx-auto p-8 py-12 animate-fade-in">
      <div className="bg-white rounded-3xl shadow-lg border border-soft-pink/20 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-soft-pink to-soft-lavender p-8 text-center">
          ...
          <p className="text-pink-50 text-sm">Track your symptoms for accurate AI predictions</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                <Activity className="w-4 h-4 text-deep-pink" /> Pain Level
              </label>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="text-sm font-medium text-gray-700 flex items-center gap-2">
                <Frown className="w-4 h-4 text-deep-lavender" /> Mood Changes
              </label>
          ...
          <div className="pt-4">
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-deep-pink hover:bg-pink-600 text-white font-bold py-3 px-4 rounded-xl transition-smooth shadow-md flex justify-center items-center disabled:opacity-50"
            >
              {loading ? (
